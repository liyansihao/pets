          ...
          <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden">
            ...
            <div className="p-10">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-center mb-8">
                Sign in to continue creating holiday magic for your pets
              </p>
              ...
              <div className="flex items-center gap-3 my-6">
                <div className="flex-1 h-px bg-slate-200 dark:bg-slate-700"></div>
                <span className="text-xs text-slate-400 dark:text-slate-500 font-medium uppercase tracking-wider">New to Pets Santa?</span>
                <div className="flex-1 h-px bg-slate-200 dark:bg-slate-700"></div>
              </div>
